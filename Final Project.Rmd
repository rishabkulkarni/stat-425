...
numerical summaries show that there is an unusual observation in the distance to the nearest MRT station: 6488.02. 
This point is much larger than the average and median distance to the nearest MRT station. The response also 
has an unusual observation, 117.50, which is further from the other observations in the response.
